...
public class CommandReactionsBuilder{
    ...
    private static final Logger logger = LoggerFactory.getLogger(CommandReactionsBuilder.class);
...
//    private String evalStorageContainerId;
    ...
    public CommandReactionsBuilder customContainerImage(Component component, String imageName){
        ...
        logger.debug("CRB *****************  (custom component={})  ,  (cleanedImageName={}) " , component,cleanedImageName  );

        customContainers.put(cleanedImageName, component);   // zookeeper
