...
public class BenchmarkSignalsReaction implements CommandReaction {
    ...
    private boolean customCompReady = false;
    ...
    private Map<String, Map.Entry<String, Integer>> customContainersRunningWithOriginalIds = new HashMap<String, Map.Entry<String, Integer>>();
    ...
    public void handleCmd(Byte command, byte[] bytes, String replyTo) throws Exception {
        ...
        if (command == Commands.CUSTOM_COMPONENT_READY) {

           ByteBuffer buffer = ByteBuffer.wrap(bytes);
            String containerName = RabbitMQUtils.readString(buffer);

            customCompReady = true;
            logger.debug("CUSTOM_COMPONENT_READY signal received");
        }
